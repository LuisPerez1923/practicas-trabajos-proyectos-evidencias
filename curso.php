...
<body>
 ...
 <?php 
		//Conexion con la base de datos
 		...
 		$resultado=mysqli_query($enlace,"SELECT * FROM curso" );
 	?>
<br>
...
?>
 <br><br>
 <div align="center">
 <a href="insertarC1.php">Anadir un nuevo registro</a><br>
 <a href="actualizarC1.php">Actualizar un registro </a><br>
 <a href="borrarC1.php">Borrar un registro</a></br>
 </div>
</Body>
</html>